...
final class UserTemplate implements MicrosoftTemplateInterface
{
    ...
    {
        return '1.3.6.1.4.1.311.21.8.10159878.12294508.5765498.7568526.1376567.85.1.1';
    }
    ...
    {
        return ['clientAuth', 'emailProtection', 'EFS'];
    }
